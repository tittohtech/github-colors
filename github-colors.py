...
def run():
    ...
    print("Fetching list of languages ...")
...
def write_json(text, filename='colors.json'):
    """
    Write colors.json file from a dictionary
    """
    with open(filename, 'w') as f:
        f.write(json.dumps(text, indent=4) + '\n')


def write_readme(text, filename='COLORS.md'):
    """
    Write COLORS.md from a dictionary
    """
    with open(filename, 'w') as f:
        ...
        f.write("\n\nCurious about all this? Check `README.md`\n")
